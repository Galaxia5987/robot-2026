...
public class ContinuousConditionalCommand extends Command {
    ...
    private boolean isOnTrueInitialized = false;
    private boolean isOnFalseInitialized = false;
    ...
    public void initialize() {
        if (m_condition.getAsBoolean()) {
            ...
            isOnTrueInitialized = true;
        } else {
            m_selectedCommand = m_onFalse;
            isOnFalseInitialized = true;
        }
